...
useEffect(() => { 
  ...
  try {
    ...
    // Build final URL (only attach params for GET here)
    let finalUrl = url;
    ...
    const res = await sendProxyRequest({
      ...
      method,
      headers: headersObj,
      params: paramsObj,   // IMPORTANT — now params work for PUT / DELETE too
      body: bodyObj        // Will be null for GET / DELETE
    });
