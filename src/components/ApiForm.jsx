  ...
  const handleSend = async () => {
    ...
    try {
      ...
      const res = await sendProxyRequest({
        ...
        method,
        headers: headersObj,
        params: paramsObj, // backend attaches query params for GET or others
        body: bodyObj,     // only for POST/PUT
      });
    ...
    <div className="flex-1 flex flex-col p-6 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 min-w-0">
      ...
      <div className="flex flex-col flex-grow space-y-4 overflow-auto">
        ...
        <input
          ...
          className={`w-full p-3 border rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700 ${
        ...
        <textarea
          ...
          className={`w-full p-3 border rounded h-24 bg-gray-50 dark:bg-gray-800 resize-none ${
        ...
        <textarea
          ...
          className={`w-full p-3 border rounded h-24 bg-gray-50 dark:bg-gray-800 resize-none ${
            errors.params ? 'border-red-500' : 'border-gray-300'
          }`}
        />
        ...
        {(method === 'POST' || method === 'PUT') && (
          <textarea
            ...
            className={`w-full p-3 border rounded h-32 bg-gray-50 dark:bg-gray-800 resize-none ${
