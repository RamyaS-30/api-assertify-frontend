      ...
      <div className="flex flex-1 items-center justify-center px-4">
        <div className="bg-white dark:bg-gray-800 shadow-2xl rounded-xl p-10 max-w-xl w-full text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            API-Assertify helps you test APIs faster and smarter.  
            Manage requests, inspect responses, store collections,  
            and simplify your workflow — all in one clean interface.
          </p>

          <p className="text-gray-600 dark:text-gray-400 mb-8">
            Whether you're debugging or exploring APIs,  
            API-Assertify gives you a powerful workspace to get things done.
          </p>

          {/* --- Buttons based on user state --- */}
          ...
          {/* If not logged in and not guest, show nothing here */}
